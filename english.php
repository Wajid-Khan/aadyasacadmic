	        		...
	        		<div class="row">
	        			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 float-right">
	        				<div class="text-warpper">
	        					<h4>Mr. Krishna Chaitanya</h4>
	        					<p class="mmfix">He has been teaching English for 10 plus years in top prominent colleges in Hyderabad. He has designed course materials as an English Department Head. He always plans well-rounded lessons that encourages students to think creatively. He is also a Cambridge Certified EFL Trainer</p>
	        					<p class="mmfix">Trained students for numerous competitive courses like </p>
	        					<ul>
	        					    <li>IELTS</li>
	        					    <li>GRE</li>
	        					    <li>TOEFL</li>
